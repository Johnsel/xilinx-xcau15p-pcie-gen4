...
module design_1
   (C0_DDR4_0_act_n,
    ...
    pcie_ref_clk_p,
    pcie_rstn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 C0_DDR4_0 ACT_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME C0_DDR4_0, AXI_ARBITRATION_SCHEME RD_PRI_REG, BURST_LENGTH 8, CAN_DEBUG false, CAS_LATENCY 16, CAS_WRITE_LATENCY 12, CS_ENABLED true, CUSTOM_PARTS no_file_loaded, DATA_MASK_ENABLED DM_NO_DBI, DATA_WIDTH 16, MEMORY_PART MT40A512M16HA-083E, MEMORY_TYPE Components, MEM_ADDR_MAP ROW_COLUMN_BANK, SLOT Single, TIMEPERIOD_PS 833" *) output C0_DDR4_0_act_n;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 C0_DDR4_0 DM_N" *) inout [1:0]C0_DDR4_0_dm_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 C0_DDR4_0 DQ" *) inout [15:0]C0_DDR4_0_dq;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 C0_DDR4_0 DQS_C" *) inout [1:0]C0_DDR4_0_dqs_c;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ddr4:1.0 C0_DDR4_0 DQS_T" *) inout [1:0]C0_DDR4_0_dqs_t;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 C0_SYS_CLK_0 CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME C0_SYS_CLK_0, CAN_DEBUG false, FREQ_HZ 200000000" *) input C0_SYS_CLK_0_clk_n;
  ...
  design_1_axi_interconnect_0_0 axi_interconnect_0
       (.ACLK(ACLK_1),
        ...
        .S00_AXI_araddr(axi_dwidth_converter_0_M_AXI_ARADDR),
        .S00_AXI_arburst(axi_dwidth_converter_0_M_AXI_ARBURST),
        .S00_AXI_arcache(axi_dwidth_converter_0_M_AXI_ARCACHE),
        .S00_AXI_arlen(axi_dwidth_converter_0_M_AXI_ARLEN),
        .S00_AXI_arlock(axi_dwidth_converter_0_M_AXI_ARLOCK),
        .S00_AXI_arprot(axi_dwidth_converter_0_M_AXI_ARPROT),
        .S00_AXI_arqos(axi_dwidth_converter_0_M_AXI_ARQOS),
        .S00_AXI_arready(axi_dwidth_converter_0_M_AXI_ARREADY),
        .S00_AXI_arregion(axi_dwidth_converter_0_M_AXI_ARREGION),
        .S00_AXI_arsize(axi_dwidth_converter_0_M_AXI_ARSIZE),
        .S00_AXI_arvalid(axi_dwidth_converter_0_M_AXI_ARVALID),
        ...
        .S00_AXI_awregion(axi_dwidth_converter_0_M_AXI_AWREGION),
        ...
        .S00_AXI_rready(axi_dwidth_converter_0_M_AXI_RREADY),
  ...
  design_1_ddr4_0_0 ddr4_0
       (.c0_ddr4_act_n(ddr4_0_C0_DDR4_ACT_N),
        ...
        .c0_ddr4_dm_dbi_n(C0_DDR4_0_dm_n[1:0]),
        .c0_ddr4_dq(C0_DDR4_0_dq[15:0]),
        .c0_ddr4_dqs_c(C0_DDR4_0_dqs_c[1:0]),
        .c0_ddr4_dqs_t(C0_DDR4_0_dqs_t[1:0]),
        .c0_ddr4_odt(ddr4_0_C0_DDR4_ODT),
        .c0_ddr4_reset_n(ddr4_0_C0_DDR4_RESET_N),
        .c0_ddr4_s_axi_araddr(axi_interconnect_0_M00_AXI_ARADDR[29:0]),
        ...
        .c0_ddr4_s_axi_awaddr(axi_interconnect_0_M00_AXI_AWADDR[29:0]),
...
module s00_couplers_imp_O7FAN0
  ...
  wire [127:0]auto_cc_to_s00_data_fifo_RDATA;
